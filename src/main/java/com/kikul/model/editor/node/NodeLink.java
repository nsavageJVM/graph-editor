...
public class NodeLink extends AnchorPane {
    ...
    public NodeLink() {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/fxml/NodeLink.fxml"));
    ...
    private void initialize() {
        ...
        node_link.controlX1Property().bind(
                Bindings.add(node_link.startXProperty(), mControlOffsetX.multiply(mControlDirectionX1)));

        node_link.controlX2Property().bind(
                Bindings.add(node_link.endXProperty(), mControlOffsetX.multiply(mControlDirectionX2)));

        node_link.controlY1Property().bind(
                Bindings.add(node_link.startYProperty(), mControlOffsetY.multiply(mControlDirectionY1)));

        node_link.controlY2Property().bind(
                Bindings.add(node_link.endYProperty(), mControlOffsetY.multiply(mControlDirectionY2)));
    }
    ...
    public void bindEnds(DraggableNode source, DraggableNode target) {
        ...
        source.registerLinkNode(target);
        target.registerLinkNode(source);
    }
}
